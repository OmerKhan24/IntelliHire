...
def submit_response(interview_id):
    ...
    try:
        ...
        if False:  # DISABLED: github_copilot_service and github_copilot_service.enabled and question and answer_text:
            try:
                import asyncio
...
def complete_interview(interview_id):
    ...
    try:
        ...
        ai_analysis = None
        if False:  # DISABLED: github_copilot_service and github_copilot_service.enabled:
            try:
                import asyncio
