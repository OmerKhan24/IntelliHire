      ...
      >
        <Box sx={{ p: 2 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            <Typography variant="h6" sx={{ fontWeight: 700, color: '#0891B2' }}>Chat History</Typography>
            <IconButton onClick={() => setSidebarOpen(false)} sx={{ color: '#0891B2' }}>
              <CloseIcon />
            </IconButton>
          </Box>
          ...
          <Divider sx={{ bgcolor: 'rgba(8, 145, 178, 0.2)', mb: 2 }} />
                        ...
                        >
                          {message.role === 'assistant' ? (
                            <ReactMarkdown
                              ...
                              components={{
                                p: ({ node, ...props }) => (
                                  <Typography variant="body1" component="p" sx={{ mb: 1 }} {...props} />
                                ),
                                ul: ({ node, ...props }) => (
                                ...
                                h1: ({ node, ...props }) => (
                                  <Typography variant="h5" component="h1" sx={{ mb: 1, mt: 1, fontWeight: 'bold' }} {...props} />
                                ),
                                h2: ({ node, ...props }) => (
                                  <Typography variant="h6" component="h2" sx={{ mb: 1, mt: 1, fontWeight: 'bold' }} {...props} />
                                ),
                                h3: ({ node, ...props }) => (
                                  <Typography variant="subtitle1" component="h3" sx={{ mb: 0.5, mt: 1, fontWeight: 'bold' }} {...props} />
                                ),
                                strong: ({ node, ...props }) => (
